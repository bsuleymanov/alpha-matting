...
from image_utils import generate_trimap, set_transform
import cv2
import random
...
class AISegmentDatasetWOTrimapV2:
    ...
    def __getitem__(self, index):
        ...
        foreground = self.foreground_transform(image=foreground)
        background = self.background_transform(image=background)
        ...
        matte = self.matte_transform(image=matte)
